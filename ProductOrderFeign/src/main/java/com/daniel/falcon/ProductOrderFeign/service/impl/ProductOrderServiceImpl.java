package com.daniel.falcon.ProductOrderFeign.service.impl;

import com.daniel.falcon.ProductOrderFeign.domain.ProductOrder;
import com.daniel.falcon.ProductOrderFeign.service.ProductClient;
...
public class ProductOrderServiceImpl implements ProductOrderService {
    ...
    public String list() {
        ...
        String response = productClient.list();
